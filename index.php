...
final class LookingGlass {
  ...
  private function render_header() {
    ...
    if ($this->frontpage['image']) {
      print('<img src="'.$this->frontpage['image'].'" alt="Logo" style="max-width: 200px; height: auto; filter: drop-shadow(2px 0 white) drop-shadow(-2px 0 white) drop-shadow(0 2px white) drop-shadow(0 -2px white);" />');
    }
    print('</div>');
    if ($this->frontpage['header_link']) {
      print('</a>');
